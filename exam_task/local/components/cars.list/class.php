...
class CBitrixOrderCarComponent extends CBitrixComponent
{

    protected $fUserId;
    protected $errors = array();

    /*Точка входа в компонент, аналог конструктора (метод подключается автоматически) */
    ...
    public function onPrepareComponentParams($arParams)
    {
     ...
     //   $this->initializeParameters($arParams);

        return $arParams;
    }

    protected function initializeParameters($arParams)
    {
